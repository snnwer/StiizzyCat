...
```
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: 5; position: fixed; right: 24dvi; top: 20dvb; width: 80dvmin; background-position: 0 0; height: 80dvmin; translate: -50% -50%; opacity: 1; background-repeat: no-repeat; background-size: 100% 100%; height: 296px; width: 296px; object-position: top; background-image: url('https://github.com/StiizzyCat/StiizzyCat/blob/main/snoop.gif?raw=true');]{x0000}$}
```
